...
<section class="bg-white dark:bg-gray-900 py-20">
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <form onsubmit="sendMail(event)" class="space-y-8">
          <div>
...
function sendMail(event) {
    ...
    const mailtoLink = `mailto:u.honeyy444@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
        `From: ${email}\n\n${message}`
    )}`;
...
</html><?php /**PATH /home/ilham/1! Project/SWU/euphoria_fashion/resources/views/contact.blade.php ENDPATH**/ ?>